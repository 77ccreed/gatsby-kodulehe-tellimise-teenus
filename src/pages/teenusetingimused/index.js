          ...
          <div className="columns">
            <div className="column is-10 is-offset-1">
              <div className="section">
                ...
                <p className="content">3.1. Teenuse tellimiseks tuleb täita <a href="https://docs.google.com/forms/d/e/1FAIpQLSe9TPVo1_SMyTlpZ6Vo0StZv0H5aoo2-K_P01o9woEdOdUsMA/viewform" target="_blank" rel="noopener noreferrer"
                  title="Kodulehe tellimise kontaktvorm">küsimustik</a>. Seejärel toimub kohtumine sobivas kohas või interneti vahendusel, millel lepitakse kokku täpsed tingimused.</p>
                <p className="content">3.2. Tellija on kohustatud enne tellimuse sooritamist kontrollima esitatavate andmete õigsust.</p>
